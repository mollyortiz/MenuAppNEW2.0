...
import MenuApp from "./components/MenuApp"; // Importing MenuApp component

// Sample data (menuData) to pass as props to MenuApp
const menuData = [
  {
    menuName: "Dinner",
    menuItems: [
...
function App() {
  return (
    <div>
      {/* Passing the menuData as a prop to the MenuApp component */}
